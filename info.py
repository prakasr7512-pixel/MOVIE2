...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1293195964 5685076977').split()] # Replace with the actual admin ID(s) to add
